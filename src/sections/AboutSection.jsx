  ...
  render() {
    return (
      <div>
        ...
        <p>
          Graduated at BTH with a bachelors degree in Software Engineering in 2017. Interested in
          just about everything that has to do with software and always on the lookout for new
          things to learn.
        </p>
        <p>
          Currently working to make the school hip with technologies such as GraphQL, Vue and Java
          at
          {' '}
...
, creating a PoC using primarily Scala,
          Grafana and the Elastic stack.
        </p>
        <p>
